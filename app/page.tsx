...
export default function DigitalSignage() {
  ...
  return (
    <div className="responsive-height-screen bg-gradient-to-br from-[#080808] via-[#0099FF] to-[#0099FF] overflow-hidden relative">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-1 bg-black/20">
        <div
          className="h-full bg-[#FF9900] transition-all duration-100 ease-linear"
