...
export default function WelcomeScreen() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-[#0099FF] via-[#0099FF] to-[#0099FF] text-white overflow-hidden relative">
      ...
      <div className="relative z-10 bg-black/30 backdrop-blur-xl border-b border-white/10 px-8 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            {/* Live Indicator */}
            <div className="flex items-center gap-2 bg-[#FF9900]/20 px-4 py-2 rounded-full border border-[#FF9900]/30">
              <div className="w-2 h-2 bg-[#FF9900] rounded-full animate-pulse"></div>
              <span className="text-[#FF9900] font-medium">LIVE</span>
            </div>
      ...
      <div className="relative z-10 flex h-[calc(100vh-100px)]">
        ...
        <div className="flex-1 p-6">
          <div className="relative h-full bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/10 overflow-hidden">
            <div className="relative h-full">
              ...
              {/* Enhanced Overlay */}
              <div className="absolute inset-0 bg-gradient-to-t from-[#0099FF]/80 via-[#0099FF]/20 to-transparent"></div>

              {/* Navigation Arrows */}
              <button
                onClick={prevImage}
                className="absolute left-6 top-1/2 transform -translate-y-1/2 bg-[#0099FF]/50 hover:bg-[#0099FF]/70 text-white p-3 rounded-full transition-all z-10 backdrop-blur-sm border border-white/20"
              >
                <ChevronLeft className="w-6 h-6" />
              </button>
              <button
                onClick={nextImage}
                className="absolute right-6 top-1/2 transform -translate-y-1/2 bg-[#0099FF]/50 hover:bg-[#0099FF]/70 text-white p-3 rounded-full transition-all z-10 backdrop-blur-sm border border-white/20"
              >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <div className="bg-[#0099FF]/60 backdrop-blur-xl rounded-2xl p-6 border border-white/20">
        ...
        <div className="w-[500px] p-6 space-y-4">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20">
            <h3 className="text-xl font-bold text-[#FF9900] mb-4 flex items-center gap-2">
              ...
              {TECH_HIGHLIGHTS.map((tech, index) => (
                <div
                  ...
                  className={`p-3 rounded-lg border transition-all ${
                    tech.active
                      ? "bg-gradient-to-r from-[#0099FF]/20 to-[#0099FF]/20 border-[#0099FF]/30"
                ...
                >
                  <div className="flex items-center gap-2">
                    <tech.icon
                      className={`w-4 h-4 ${
                        tech.active ? "text-[#0099FF]" : "text-white/60"
                      }`}
                    />
                    <span
                  ...
                  {tech.active && (
                    <div className="mt-2">
                      <div className="w-full bg-white/10 rounded-full h-1">
                        <div
                          className="bg-gradient-to-r from-[#0099FF] to-[#FF9900] h-1 rounded-full animate-pulse"
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20">
            ...
            <div className="relative rounded-xl bg-gradient-to-r from-[#0099FF]/20 to-[#0099FF]/20 border border-[#0099FF]/30 p-4">
          ...
          <div className="bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-sm rounded-2xl p-6 shadow-2xl border-2 border-[#FF9900]/30">
            <h3 className="text-xl font-bold text-[#FF9900] mb-4 flex items-center gap-2">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between p-3 bg-gradient-to-r from-[#0099FF]/20 to-[#0099FF]/10 rounded-xl border border-[#0099FF]/30">
                <div className="flex items-center gap-3">
                  <Wifi className="w-4 h-4 text-[#0099FF]" />
                  <span className="text-white font-medium">Network Status</span>
                </div>
                <span className="text-lg font-bold text-[#0099FF]">
                  Optimal
                </span>
              </div>
              <div className="flex items-center justify-between p-3 bg-gradient-to-r from-[#FF9900]/20 to-[#FF9900]/10 rounded-xl border border-[#FF9900]/30">
                <div className="flex items-center gap-3">
                  <Coffee className="w-4 h-4 text-[#FF9900]" />
                  <span className="text-white font-medium">Cafeteria</span>
                </div>
                <span className="text-lg font-bold text-[#FF9900]">Open</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20">
            ...
            <div className="space-y-2">
              <button className="w-full text-left p-3 bg-gradient-to-r from-white/10 to-white/5 hover:from-[#0099FF]/20 hover:to-[#0099FF]/10 rounded-xl transition-all border border-white/10 hover:border-[#0099FF]/30">
